...
import PromotionTable from "../../super-admin/components/promotion-management/PromotionTable"
import Pagination from "../../super-admin/components/common/Pagination"
import EditPromotionModal from "../../super-admin/components/promotion-management/EditPromotionModal"
import CreatePromotionModal from "../../super-admin/components/promotion-management/CreatePromotionModal"
import ConfirmDeleteModal from "../../super-admin/components/common/ConfirmDeleteModal"
...
} from "../../super-admin/services/promotionService"

import PromotionFilters from "../../super-admin/components/promotion-management/PromotionFilters"
...
function PromotionManagementPage() {
  ...
  const loadPromotions = async () => {
    try {
      ...
      const filtered = data.filter(p => !p.applicableBranchId || p.applicableBranchId === myBranchId)
