...
import { cilSearch, cilUser, cilAccountLogout } from "@coreui/icons"
...
function PtHeader() {
  ...
  const fetchHeaderProfile = () => {
    ...
    let defaultRole = "PT"
    let defaultName = "Huấn Luyện Viên"
    let defaultAvatar = ""
    ...
    }).catch(e => console.error("Error fetching PT profile", e))
  }
              ...
              <div className="d-flex align-items-center" style={{ cursor: "pointer" }}>
                ...
                <div style={{ textAlign: "left" }} className="d-none d-md-block">
                  <div style={{ fontWeight: 500 }}>
                    {userProfile?.fullName || "Huấn Luyện Viên"}
                  </div>
                  <small style={{ color: "#888" }}>
                    {userProfile?.role || "Personal Trainer"}
                  </small>
                </div>
              </div>
            </CDropdownToggle>
