          ...
          <div className="flex flex-col justify-center p-8 md:p-12 bg-[var(--surface)]">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm text-[var(--text-secondary)] font-medium">Chuyên môn</p>
                  <p className="text-base text-[var(--text-primary)] font-semibold">{pt.specialty}</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-sm text-[var(--text-secondary)] font-medium">Kinh nghiệm</p>
                  <p className="text-base text-[var(--text-primary)] font-semibold">{pt.experience}</p>
                </div>
              </div>
            </div>

            <p className="text-base text-[var(--text-secondary)] leading-relaxed mb-8 border-l-4 border-[var(--border)] pl-4">
              "Tôi cam kết đồng hành cùng bạn trên mỗi bước tiến, biến mục tiêu hình thể của bạn thành hiện thực với lộ trình tập luyện khoa học và cá nhân hóa."
            </p>
