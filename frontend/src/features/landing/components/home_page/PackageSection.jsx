            ...
            {loading ? (
                ...
                ">
                    {packages.map((pkg, index) => {
                        ...
                        const price = pricing ? pricing.price.toLocaleString(locale === 'vi' ? 'vi-VN' : 'en-US') : t('packages.contact');
                        const period = pricing ? (pricing.durationMonths === 1 ? t('packages.month') : `${pricing.durationMonths} ${t('packages.months')}`) : t('packages.month');
