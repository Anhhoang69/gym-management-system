...
\hline
\textbf{Tên công cụ (Tool Name)} & \textbf{MB} & \textbf{SL} & \textbf{PT} & \textbf{HP} & \textbf{RC} & \textbf{BA} & \textbf{OW} & \textbf{AD} \\
\hline
\endfirsthead
...
\hline
get\_available\_packages & \checkmark & & & & & & & \\
\hline
get\_my\_schedule & \checkmark & & & & & & & \\
\hline
book\_class & \checkmark & & & & & & & \\
\hline
cancel\_booking & \checkmark & & & & & & & \\
\hline
get\_attendance\_summary & \checkmark & & & & & & & \\
\hline
generate\_fitness\_plan & \checkmark & & & & & & & \\
\hline
ask\_fitness\_coach & \checkmark & & & & & & & \\
\hline
get\_lead\_summary & & \checkmark & & & & \checkmark & \checkmark & \checkmark \\
\hline
get\_lead\_pipeline & & \checkmark & & & & \checkmark & \checkmark & \checkmark \\
\hline
get\_sales\_funnel & & \checkmark & & & & \checkmark & \checkmark & \checkmark \\
\hline
contract\_lookup & & \checkmark & & & \checkmark & \checkmark & \checkmark & \checkmark \\
\hline
get\_class\_roster & & & \checkmark & \checkmark & & \checkmark & \checkmark & \checkmark \\
\hline
get\_member\_training\_overview & & & \checkmark & \checkmark & & \checkmark & \checkmark & \checkmark \\
\hline
get\_my\_teaching\_schedule & & & \checkmark & \checkmark & & & & \\
\hline
get\_pt\_performance & & & & \checkmark & & \checkmark & \checkmark & \checkmark \\
\hline
checkin\_lookup & & & & & \checkmark & \checkmark & \checkmark & \checkmark \\
\hline
booking\_lookup & & & & & \checkmark & \checkmark & \checkmark & \checkmark \\
\hline
member\_lookup & & \checkmark & & & \checkmark & \checkmark & \checkmark & \checkmark \\
\hline
get\_checkin\_report & & & & & & \checkmark & \checkmark & \checkmark \\
\hline
get\_branch\_revenue & & & & & & \checkmark & \checkmark & \checkmark \\
\hline
get\_branch\_payroll & & & & & & \checkmark & \checkmark & \checkmark \\
\hline
get\_global\_revenue & & & & & & & \checkmark & \checkmark \\
\hline
get\_system\_dashboard & & & & & & & \checkmark & \checkmark \\
\hline
get\_payroll\_overview & & & & & & & \checkmark & \checkmark \\
\hline
\caption{Ma trận phân quyền chi tiết cho tất cả 25 công cụ AI}
\label{tab:ai-rbac}
\end{longtable}
\noindent \textit{Ký hiệu viết tắt:} MB (Member), SL (Sales), PT (PT), HP (HeadPT), RC (Receptionist), BA (BranchAdmin), OW (GymOwner), AD (SuperAdmin).
