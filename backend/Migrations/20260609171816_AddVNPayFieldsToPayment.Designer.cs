...
namespace backend.Migrations
{
    ...
    [Migration("20260609171816_AddVNPayFieldsToPayment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.AIContextCache", b =>
                {
                    b.Property<Guid>("MemberId")
                        .HasColumnType("uuid");

                    b.Property<string>("CachedContext")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("backend.Models.AIRecommendation", b =>
                {
                    ...
                    b.Property<string>("NutritionAdvice")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("backend.Models.AITokenUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AITokenUsageLogs");
                });

            modelBuilder.Entity("backend.Models.AIToolExecutionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Models.NotificationRecipient", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.PackagePolicy", b =>
                {
                    ...
                    b.Property<bool>("EarlyRenewAllowed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("backend.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime?>("GatewayPayDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("GatewayRawData")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    ...
                    b.Property<Guid?>("InitialBranchId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Models.AIContextCache", b =>
                {
                    b.HasOne("backend.Models.Member", "Member")
                        .WithOne("AIContextCache")
                        .HasForeignKey("backend.Models.AIContextCache", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Models.User", b =>
                {
                    b.HasOne("backend.Models.Branch", "InitialBranch")
                        .WithMany()
                        .HasForeignKey("InitialBranchId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("InitialBranch");
                });
